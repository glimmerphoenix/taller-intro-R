...
![Fig. 1. Interfaz gráfica de RStudio.](img/RStudio-IDE.png)
...
![Fig. 2. Línea de código en la consola.](img/consola.jpg)
...
![Fig. 3. Environment.](img/environment.jpg)
...
![Fig. 5. Packages e instalación de paquetes.](img/packages.jpg)
...
![Fig. 8. Selección del directorio de trabajo.](img/session.jpg)
...
![Fig. 9. Paso 1: ventana New Project.](img/new_project.jpg)

Haciendo click en *New Directory*, llegaremos a la siguiente ventana donde debemos seleccionar la opción *New Project*:

![Fig. 10. Paso 2: ventana New Directory.](img/new_project_step2.jpg)
...
![Fig. 11. Paso 3: nombre del proyecto.](img/new_project_step3.jpg)
...
![Fig. 12. Paso 4: cógido del proyecto.](img/proyecto1.jpg)
...
![Fig. 13. Abrir el proyecto.](img/abrir_new_project.jpg)
