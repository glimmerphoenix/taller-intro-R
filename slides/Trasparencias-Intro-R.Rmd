...
- RStudio: entorno de progrmación. 
  ...
  - Algunas de estas expresiones (siempre y cuando sean correctas) pueden producir una salida visible que se puede almacenar en alguna variable, en disco o en un fichero. 
...
```{r imagen-IDE, echo=FALSE, out.width = "60%"}
...
# Controlamos tamaño de la figura
knitr::include_graphics("imagenes/environment.jpg")
```
...
1. Menú *File* -> *New Porject*.

```{r imagen-newproject, echo=FALSE, out.width = "60%"}
# Controlamos tamaño de la figura
knitr::include_graphics("imagenes/new_project.jpg")
```

2. Opción *New Directory*, seleccionams la opción *New Project*:

```{r imagen-newproject2, echo=FALSE, out.width = "60%"}
# Controlamos tamaño de la figura
knitr::include_graphics("imagenes/new_project_step2.jpg")
```

3. Nombre del proyecto y hacemos click en *Create Project*.
...
# 2. Introducción al lenguaje R. Programación científica en R
...
- `apply(matrix, i, fun)`
  ...
  - Si `i=1`: aplica `fun` a todas las ficlas de `matrix`
